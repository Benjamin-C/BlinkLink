 ...
 */
public class BlinkLink implements Serializable {
    ...
    public BlinkLink(Location from, Location to) {
        setFrom(from);
        setTo(to);
    }
    protected BlinkLink() {
    ...
    public boolean equals(Object thatObj) {
        if(thatObj != null && thatObj instanceof BlinkLink) {
            BlinkLink that = (BlinkLink) thatObj;
